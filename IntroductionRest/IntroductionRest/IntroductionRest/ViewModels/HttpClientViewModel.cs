...
{
    public class HttpClientViewModel : ViewModelBase
    {
        ...
        public HttpClientViewModel(IRestService restService)
        {
        ...
        {
            Content = await _restService.GetRestServiceData(RestService.RestServiceType.HttpClient);
        }
    }
}
